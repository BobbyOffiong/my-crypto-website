        ...
        <div className="flex space-x-4 text-gray-600">
          {[
            ...
            <a
              key={index}
              href={social.href}
              className="hover:text-orange-300 active:text-orange-500 focus:text-orange-500 transition"
            >
      ...
      <div className="flex justify-between items-center px-4 py-3 bg-blue-500 text-white">
        ...
        <div className="md:hidden">
          <button
            ...
            className="text-white hover:text-orange-300 active:text-orange-500 focus:text-orange-500 transition"
          >
          ...
          {isMobileMenuOpen && (
            <nav className="mobile-menu absolute w-full bg-blue-500/90 text-white">
              <div className="flex justify-end p-4">
                <button
                  onClick={toggleMobileMenu}
                  className="text-white text-2xl hover:text-orange-300 active:text-orange-500 focus:text-orange-500 transition"
                >
                  &times;
                </button>
              </div>
